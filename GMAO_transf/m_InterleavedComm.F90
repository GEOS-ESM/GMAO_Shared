...
!BOP -------------------------------------------------------------------
!
! !MODULE: m_InterleavedComm - communcation operations
!
! !DESCRIPTION:
!
! !INTERFACE:
...
!EOP ___________________________________________________________________
  ...
  character(len=*),parameter :: myname='m_InterleavedComm'
...
! !INTERFACE:
    ...
    subroutine alloc_scatterv4_(im,jm,ob,send,recv,root,comm,name,stat)
      ...
      type(InterleavedObject),intent(in) :: Ob
...
do irecv=1,maximSize(ob)
  ...
  call get(ob,irecv,root=root,dstrcount=rcount,	&
...
do isend=1,maximSize(ob)
  ...
  call get(ob,isend,root=root,dstrcount=scount,	&
