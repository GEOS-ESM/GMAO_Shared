...
* -----------------------------------------------------------------
* Note:  RMS_0**2 = RMS_1(RANDOM)**2   +  RMS_2(BAR=BIAS)**2
*                 = RMS_3(DISSIPATION) +  RMS_4(DISPERSION)
*
* Define: MSE      = MSE_BIAS + MSE_AMPL + MSE_PHAZ
*  where: MSE_AMPL = RMS_3 - RMS_2**2
*         MSE_PHAZ = RMS_4
* -----------------------------------------------------------------
...
if( xpos = 12 ) ; region = "S.Polar (Lats:-90,-60)"                     ;  reg = "SPO"  ; endif
...
'define 'field'rms'n.m'    = pow(         'scale'*'field'rms.'n.m'(t+'toffset')    ,'rmsfact' )'
'define 'field'rmsran'n.m' = pow(         'scale'*'field'rms_ran.'n.m'(t+'toffset'),'rmsfact' )'
'define 'field'rmsbar'n.m' = pow(         'scale'*'field'rms_bar.'n.m'(t+'toffset'),'rmsfact' )'
'define 'field'rmsdsp'n.m' = pow( 'scale'*'scale'*'field'rms_dsp.'n.m'(t+'toffset'),'dspfact' )'
'define 'field'rmsdis'n.m' = pow( 'scale'*'scale'*'field'rms_dis.'n.m'(t+'toffset'),'disfact' ) - 'field'rmsbar'n.m
n = n + 1
endwhile
m = m + 1
endwhile
...
if( rms = 3 ) ; 'define  q'm' = 'field'rmsdis'n.m ; 'define z0'n'e'm' = q0'm ; endif
if( rms = 4 ) ; 'define  q'm' = 'field'rmsdsp'n.m ; 'define z0'n'e'm' = q0'm ; endif
                                                    'define  z'n'e'm' =  q'm
n = n + 1
endwhile
m = m + 1
...
if( rms = 3 ) ; 'define ctl  = 'field'rmsdis'n ; 'define dum = 'field'rmsdis'n.m ; 'define dq0'm' = (ctl0-dum0)' ; 'define zd0'n'e'm' = dq0'm ; endif
if( rms = 4 ) ; 'define ctl  = 'field'rmsdsp'n ; 'define dum = 'field'rmsdsp'n.m ; 'define dq0'm' = (ctl0-dum0)' ; 'define zd0'n'e'm' = dq0'm ; endif
...
'set t 'tbeg.m' 'tdim.m
if( rms != 0 )
 'define zave0'm'  = pow( abs( zave0'm' ),'irmsfact' )'
 'define zvar0'm'  = pow( abs( zvar0'm' ),'irmsfact' )'
 'define zvard0'm' = pow( abs( zvard0'm'),'irmsfact' )'
endif
