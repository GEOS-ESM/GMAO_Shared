...
! **********************************************************************
      ...
      character*256 dynrst, moistrst, topo
...
! **********************************************************************
      ...
      lm_in = headr2(3)
          ...
          print *, '      input resolution: ',im,jm,lm_in
...
! if we are on the cube (check for jm being equal to im*6) write out dz and w
       if(jm.eq.im*6) then
          do L=1,lm_out
             write(10) (( dz_out(i,j,L),i=1,im),j=1,jm)
          enddo
          do L=1,lm_out
...
! Note: no need to provide first guess of A6 <-- a4(4,i)
      ...
      print *, "  -topo         topo_fname:  Filename of    topography"
      print *, "  -lm                   LM:  Output Veritcal Resolution"
      print *
