...
sub init {
    ...
    #-----------------------
    chomp($statsX = `which statsNx.x`);
    die "Error. Cannot find statsNx.x program;" unless -e $statsX;
...
\${PESTOROOT}%s/prog/$fs_tag/Y%y4/M%m2/%s.%H2z.inst1_2d_asm_Nx.globl.b%y4%m2%d2_%h2z.e%Y4%M2%D2_%H2z.ctl
\${PESTOROOT}%s/prog/$fs_tag/Y%y4/M%m2/%s.%H2z.inst1_2d_asm_Nx.globl.b%y4%m2%d2_%h2z.e%Y4%M2%D2_%H2z.data
\${PESTOROOT}%s/prog/$fs_tag/Y%y4/M%m2/%s.%H2z.inst1_2d_asm_Nx.stats.b%y4%m2%d2_%h2z.e%Y4%M2%D2_%H2z.ctl1
\${PESTOROOT}%s/prog/$fs_tag/Y%y4/M%m2/%s.%H2z.inst1_2d_asm_Nx.stats.b%y4%m2%d2_%h2z.e%Y4%M2%D2_%H2z.ctl2
\${PESTOROOT}%s/prog/$fs_tag/Y%y4/M%m2/%s.%H2z.inst1_2d_asm_Nx.stats.b%y4%m2%d2_%h2z.e%Y4%M2%D2_%H2z.data
