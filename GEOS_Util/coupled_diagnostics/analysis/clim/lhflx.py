...
obs.clim=obs.ctllhsh('lhtfl').clim(12)
obs.clim.data*=-1
...
clevs1=sp.arange(0.0,251.0,25.0); clevs2=sp.arange(-50.,51.0,10.)    
frange=(-1,1)
path=exp.plot_path
try:
    os.makedirs(path)
