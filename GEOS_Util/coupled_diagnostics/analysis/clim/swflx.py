...
obs.clim=obs.ctllwsw('nswrs').clim(12)
...
clevs1=sp.arange(0.0,301.0,30.); clevs2=sp.arange(-50.,51.0,10.)    
frange=(-1,1)
path=exp.plot_path
try:
    os.makedirs(path)
