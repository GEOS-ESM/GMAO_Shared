...
obs.clim=obs.ctl('s_an',levs=(0,10)).ave(1)
...
clevs1=sp.arange(32.0,38.1,0.4); clevs2=sp.arange(-5.,5.1,0.5)    
frange=(-0.5,0.5)
path=exp.plot_path
try:
    os.makedirs(path)
