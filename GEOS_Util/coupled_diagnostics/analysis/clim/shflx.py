...
obs.clim=obs.ctllhsh('shtfl').clim(12)
obs.clim.data*=-1
...
clevs1=sp.arange(0.0,101.0,10.0); clevs2=sp.arange(-20.,21.0,5.)    
frange=(-1,1)
path=exp.plot_path
try:
    os.makedirs(path)
