module ncdr_global_attrs
    ...
    contains
        ...
        subroutine nc_diag_read_noid_get_global_attr_names(dummy,num_global_attrs, attr_name_mlen, attr_names)
            character(len=*),intent(in)              :: dummy ! MAT A dummy argument is needed so that Fortran
                                                              !     can distinguish between the _id_ and _noid_
