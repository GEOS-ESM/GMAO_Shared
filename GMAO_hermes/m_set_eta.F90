...
! For ML levels
      data l181tol41 /0,2,5,8,11,14,17,20,23,26,29,32,35,38,41,44,47,50,53,56,60,64,69,74,80,85,90,95,100,105,110,115,120,125,130,135,140,145,152,160,170,181/
...
! Extended model top
      ...
      data a187 /0.0000300, 0.00049276, 0.00435689, 0.0230675, 0.0831358, 0.231856,    &
               1.0000000, 1.6461494, 2.3988098, 3.3373925, 4.5180100,  &
               5.9846950, 7.7937295, 10.010172, 12.710444, 15.973860,  &
               19.886346, 24.538486, 30.024769, 36.447639, 43.915803,  &
               52.545737, 62.453836, 73.764708, 86.607943, 101.11680,  &
      ...
      data b187  /0.00000, 0.00000, 0.00000, 0.00000, &
               0.00000, 0.00000, 0.00000, 0.00000, 0.00000,  &
               0.00000, 0.00000, 0.00000, 0.00000, 0.00000,  &
               0.00000, 0.00000, 0.00000, 0.00000, 0.00000,  &
               0.00000, 0.00000, 0.00000, 0.00000, 0.00000,  &
...
! *** GEOS-5
   ...
   ! ML levels as a subset of L181
        case (41)
        do k=1,km+1
          ak(k) = a181(l181tol41(k)+1)
          bk(k) = b181(l181tol41(k)+1)
        end do
