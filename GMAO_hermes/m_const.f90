...
!BOP
!
! !MODULE:  m_const --- Defines physical constants
! 
! !INTERFACE:
!
...
!  24jan2014  Todling   Revisit constants (WMO defs; MAPL sync)
!
!EOP
!-------------------------------------------------------------------------
...
!!!   real, parameter ::  grav   = 9.80616
      real, parameter ::  grav   = 9.80665 ! WMO
...
!     real, parameter ::  alhl   = 2.499e6  ! Latent heat consensation
      ...
      real, parameter ::  runiv  = 8314.47  
      real, parameter ::  rgas   = runiv/airmw ! MAPL
